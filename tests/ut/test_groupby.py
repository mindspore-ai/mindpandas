...
def test_groupby_groups():
    ...
    TESTUTIL.compare(test_groupby_list_of_dict_mapping, create_input_dataframe, skip=True)
    TESTUTIL.compare(test_axis1_lst_injective_mapping, create_input_dataframe)
    TESTUTIL.compare(test_axis1_dict_mapping, create_input_dataframe, skip=True)
